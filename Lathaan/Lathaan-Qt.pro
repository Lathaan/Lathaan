...
contains(LATHAAN_NEED_QT_PLUGINS, 1) {
    DEFINES += LATHAAN_NEED_QT_PLUGINS
...
HEADERS += src/qt/lathaangui.h \
    ...
    src/qt/lathaanaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/lathaan.cpp src/qt/lathaangui.cpp \
    ...
    src/qt/lathaanaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/lathaanstrings.cpp \
    src/qt/lathaanamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/lathaan.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/lathaan_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/lathaan-qt.rc
...
windows:RC_FILE = src/qt/res/lathaan-qt.rc
...
macx:ICON = src/qt/res/icons/Lathaan.icns
macx:TARGET = "Lathaan-Qt"
