...
function StartThree {
  $LATHAAND $LATHAANDARGS $B1ARGS &
  B1PID=$!
  $LATHAAND $LATHAANDARGS $B2ARGS &
  B2PID=$!
  $LATHAAND $LATHAANDARGS $B3ARGS &
  B3PID=$!
}
