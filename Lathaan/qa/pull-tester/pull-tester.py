...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old LathaanPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/LathaandComparisonTool_jar/LathaandComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/lathaan/lathaan.git")
...
environ_default("BUILD_PATH", "/mnt/lathaan")
...
environ_default("GITHUB_REPO", "lathaan/lathaan")
