...
private slots:
    ...
    void on_BuyLTH_clicked();
    void on_SellLTHBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputLTH_textChanged(const QString &arg1);
    ...
    QString BuyLTH(QString OrderType, double Quantity, double Rate);
    QString SellLTH(QString OrderType, double Quantity, double Rate);
