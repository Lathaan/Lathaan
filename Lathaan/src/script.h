...
#ifndef H_LATHAAN_SCRIPT
#define H_LATHAAN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CLathaanAddress
 */
...
public:
    ...
    // Pre-version-0.6, Lathaan always counted CHECKMULTISIGs
